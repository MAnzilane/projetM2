...
def main():
    environment = gym.make('Grid-World-v0', grid_width=GRID_COLUMNS, grid_height=GRID_ROWS, obstacles=[5, 10, 18])
    # print(environment.observation_space.shape)
    # print(dir(environment.observation_space.spaces))
    # print(environment.observation_space.spaces.count)
    ...
    for trial in range(episodes):
        ...
        #
        current_state = environment.reset().reshape(1, 2)
